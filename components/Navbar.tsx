          ...
          <div className="hidden lg:flex items-center space-x-2">
            ...
            {isAuthenticated ? (
              <div className="flex items-center space-x-2">
                ...
                <div
                  className="w-8 h-8 rounded-[6px] border border-slate-300 dark:border-slate-600 flex items-center justify-center overflow-hidden"
                  title={user?.name}
                >
                  ...
                  {link.children ? (
                    ...
                    <>
                      <div className="flex items-center">
                        ...
                        >
                          <FaChevronDown
                            className={`text-xs transition-transform duration-200 ${mobileDropdown === link.name ? "rotate-180" : ""}`}
                          />
                        </button>
                      </div>
                      <AnimatePresence>
