...
export default function NotificationBell() {
  ...
  const notifIcon = (type: string) => {
    ...
    if (type === "class_cancelled")
      return <FaBan className="text-red-500 text-sm" />;
    if (type === "class_reminder")
      return <FaClock className="text-amber-500 text-sm" />;
                  ...
                  >
                    ...
                    <div className="flex-1 min-w-0">
                      <div className="flex items-center gap-1.5">
                        <p
                          className={`text-xs font-medium ${n.read ? "text-slate-500 dark:text-slate-400" : "text-slate-800 dark:text-white"}`}
                        >
                          {n.title}
                        </p>
                        {!n.read && (
